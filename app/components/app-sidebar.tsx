  ...
  return (
    <Sidebar {...props} className="dark !border-none">
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="uppercase text-sidebar-foreground/50 flex items-center justify-between">
            {data.navMain[0]?.title}
            <RiAddLine className="cursor-pointer hover:text-sidebar-foreground" />
          </SidebarGroupLabel>
